...
execute_process(
  COMMAND "/usr/bin/git" show-ref "9a3624205e8774953ef18f57067b3426c1c5ada6"
  WORKING_DIRECTORY "/home/josiah/euclid/promenade/build-arm-ubuntu-release/yaml-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "9a3624205e8774953ef18f57067b3426c1c5ada6")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("9a3624205e8774953ef18f57067b3426c1c5ada6" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/9a3624205e8774953ef18f57067b3426c1c5ada6")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/josiah/euclid/promenade/build-arm-ubuntu-release/yaml-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/josiah/euclid/promenade/build-arm-ubuntu-release/yaml-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
